                    ...
                    <TechFrame color={asset.color} className="w-ful                        <Box 
                        ...
                        >
                            ...
                            <Box sx={{ textAlign: { xs: 'left', sm: 'right' }, minWidth: 120 }}>
                                    <Typography variant="h6" sx={{ color: asset.color, fontWeight: 'bold', display: 'flex', alignItems: 'center', justifyContent: { xs: 'flex-start', sm: 'flex-end' }, gap: 0.5 }}>
                                    {asset.value.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} <TaoIcon size={12} color={asset.color} />
                                    </Typography>
                                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, justifyContent: { xs: 'flex-start', sm: 'flex-end' }, mt: 0.5 }}>
                                        <LinearProgress 
                                        variant="determinate" 
